...
--Create Admin
INSERT INTO `account` (`user_name`, `password`, `user_type`, `new_password`) VALUES ('Admin', 'Password', '1', NULL);

--Create User
INSERT INTO `account` (`user_name`, `password`, `user_type`, `new_password`) VALUES ('User', 'MyBirthday123', '0', NULL);
